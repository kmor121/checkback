...
import { Download, ZoomIn, ZoomOut, User } from 'lucide-react';
...
import CommentComposer from '../components/share/CommentComposer';
import CommentList from '../components/share/CommentList';
...
function ShareViewContent() {
  ...
  // ★★★ CRITICAL: composerMode定義直後に配置（TDZ回避）★★★
  ...
  <div className="max-w-full mx-auto h-screen flex flex-col">
    <DiagnosticHUD
      diagEnabled={typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('diag') === '1'}
      paintMode={paintMode}
      canPost={canPost}
      shareLink={shareLink}
      isReady={isReady}
      normalizedActiveCommentId={normalizedActiveCommentId}
      isUnselected={isUnselected}
      isTempDraftPreview={isTempDraftPreview}
      tempDraftCount={tempDraftCount}
      composerMode={composerMode}
      paintContextId={paintContextId}
      targetKey={targetKey}
      debugButtonEnabled={debugParam === '1' || (typeof window !== 'undefined' && localStorage.getItem('forceDebug') === '1') || DEBUG_MODE}
      tool={tool}
      ...
      shapesFetching={shapesFetching}
      paintShapesLength={paintShapes.length}
      draftShapesLength={draftShapes.length}
      shapesForCanvasLength={shapesForCanvas.length}
      isCanvasTransitioning={isCanvasTransitioning}
      canvasInternalResetKey={canvasInternalResetKey}
      debugLogBufferRef={debugLogBufferRef}
      showToast={showToast}
      debugMode={DEBUG_MODE}
      draftDebugInfo={draftDebugInfo}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 grid grid-rows-[1fr_auto] min-h-0">
          ...
          <CommentComposer
            ...
            activeCommentId={activeCommentId}
            paintMode={paintMode}
            handlePaintModeChange={handlePaintModeChange}
            composerMode={composerMode}
            composerText={composerText}
            setComposerText={setComposerText}
            enterNewTextOnlyComposer={enterNewTextOnlyComposer}
            setIsNewCommentInputActive={setIsNewCommentInputActive}
            ...
            targetKey={targetKey}
            paintSessionCommentId={paintSessionCommentId}
            tempDraftCount={tempDraftCount}
            setActiveCommentId={setActiveCommentId}
            setIsTempDraftPreview={setIsTempDraftPreview}
            setComposerMode={setComposerMode}
            setComposerTargetCommentId={setComposerTargetCommentId}
            setShowAllPaint={setShowAllPaint}
        ...
        <CommentList
          ...
          tempDraftCount={tempDraftCount}
          getTempDraftKeyForPreview={getTempDraftKeyForPreview}
          setActiveCommentId={setActiveCommentId}
          setIsTempDraftPreview={setIsTempDraftPreview}
          setComposerMode={setComposerMode}
          setComposerTargetCommentId={setComposerTargetCommentId}
          ...
          draftCacheRef={draftCacheRef}
          setDraftShapes={setDraftShapes}
          draftShapesRef={draftShapesRef}
          resolveCommentId={resolveCommentId}
          normId={normId}
          tempCommentId={tempCommentId}
          setTempCommentId={setTempCommentId}
          showToast={showToast}
          sortedComments={sortedComments}
          paintShapes={paintShapes}
          activeCommentId={activeCommentId}
          isNewTextOnlyComposerActive={isNewTextOnlyComposerActive}
          composerMode={composerMode}
          composerTargetCommentId={composerTargetCommentId}
          paintMode={paintMode}
          paintSessionCommentId={paintSessionCommentId}
          repliesByParent={repliesByParent}
          attachmentsByComment={attachmentsByComment}
          replyingThreadId={replyingThreadId}
          setReplyingThreadId={setReplyingThreadId}
          draftCountByCommentId={draftCountByCommentId}
          ...
          handleCopyCommentUrl={handleCopyCommentUrl}
          canEditDeleteComment={canEditDeleteComment}
          composerText={composerText}
          setComposerText={setComposerText}
          composerParentCommentId={composerParentCommentId}
          pendingFiles={pendingFiles}
          handleRemoveFile={handleRemoveFile}
          handleFileSelect={handleFileSelect}
          handleSendComment={handleSendComment}
          isSubmitting={isSubmitting}
          setComposerParentCommentId={setComposerParentCommentId}
